...
const packageObjectAdmin = grpcLibrary.loadPackageDefinition(packageDefinition).aff_players;
...
const ServiceClient = new packageObjectAdmin.AffPlayersService(process.env.GRPC_AFF_PLAYER_URL,credentials,{
