...
const packageObject = grpcLibrary.loadPackageDefinition(packageDefinition).groups;
...
const client = new packageObject.GroupsService(process.env.GRPC_AGENT_URL,credentials);
module.exports  = {
