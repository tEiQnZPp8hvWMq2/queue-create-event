if(!process.env.GRPC_AGENT_SETTINGS_URL) throw '.env GRPC_AGENT_SETTINGS_URL';
...
const client = new packageObject.AgentsService(process.env.GRPC_AGENT_SETTINGS_URL,credentials,{
